                            ...
                            <div class="inner">
                                ...
                                <nav id="nav">
                                    <ul>
                                        ...
                                        <li><a href="usuariosAdmin.php">Gestión Usuarios</a></li>                                       
                                    </ul>
                                </nav>
                            </div>
                        </header>   
                            ...
                            <div class="row-fluid">                    
                                <div data-role="content">                                  
                                    <div id="usuario" >
                                        ...
                                        <form role="form" action="../../controlador/Admin/crearUsuarioAdmin.php" method="post"  data-ajax="false" onSubmit="return validarCampos();" >
