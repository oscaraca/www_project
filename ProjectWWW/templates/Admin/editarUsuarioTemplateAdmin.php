...
function obtenerAtributoUsuario($tipo) {
    ...
    $db = getDB();   
    session_start();
    $usuario_id = $_SESSION['usuarioAdmin'];
                            ...
                            <div class="row-fluid">                    
                                <div data-role="content">                                  
                                    <div id="usuario" >
                                        ...
                                        <form role="form" action="../../controlador/Admin/editarUsuarioAdmin.php" method="post"  data-ajax="false" onSubmit="return validarCampos();" >
