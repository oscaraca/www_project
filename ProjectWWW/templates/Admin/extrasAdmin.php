                    ...
                    <section class="container box-feature1">
                        ...
                        <div class="row">
                            <div class="4u">                            
                                <section>
                                    <center>                                       
                                        <a href="crearExtraTemplateAdmin.php"><img src="../../images/pic01.jpg" HEIGHT=235 WIDTH=300 alt=""></a>
                                    </center>
                            ...
                            <div class="4u">                            
                                <section>
                                    <center>                                       
                                        <a href="editarExtraTemplateAdmin.php"><img src="../../images/edit_male_user_98373.jpg" HEIGHT=235 WIDTH=300 alt=""></a>
                                    </center>
                                    <header class="second fa fa-user">
                                        <h3>Extras</h3>
                            ...
                            <div class="4u">                            
                                <section>
                                    <center>                                       
                                        <a href="eliminarExtraTemplateAdmin.php"><img src="../../images/remove_male_user_98400.jpg" HEIGHT=235 WIDTH=300 alt=""></a>
                                    </center>
                                    <header class="second fa fa-user">
                                        <h3>Extras</h3>
