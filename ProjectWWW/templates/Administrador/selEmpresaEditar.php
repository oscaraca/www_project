...
<html>
    <head>        
        <title>Seleccionar Empresa Editar</title>
        <!-- StyleSheet -->
            ...
            <div class="container">
                <div class="row">
                    <div class="12u">
                        ...
                        <!-- Banner -->
                        <div id="banner">
                            <h2><strong>Seleccionar Empresa</strong> 
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row-fluid">                    
                                <div data-role="content">                                  
                                    <div id="usuario" >
                                        ...
                                        <form action="editarEmpresaTemplateAdministrador.php" method="post"  data-ajax="false" >    
                                            ...
                                            <div class="form-group">
                                                <button class="btn btn-primary btn-block form-control">Editar Empresa</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
